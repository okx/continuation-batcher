cargo run --release -- --output ./output batch --challenge poseidon -k 22 --info output/zkwasm.loadinfo.json --info output/POSEIDONHASH.loadinfo.json --name batchsample --commits sample/commits1.json
